...
public class ClientService {
    ...
    /*public Client searchByEmail(String email) {
        return clientRepositoryy.findByEmail(email);
    }*/
    ...
    public void updateClient(UUID id, ClientDto clientDto, String password)
    ...
    private Client findOrThrow(final UUID id) {
